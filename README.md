...
로봇팔 하나를 손으로 움직이는 데서 시작해, 목표 좌표만 주면 스스로 경로를 짜서 집고 놓는 데까지의 과정을 담은 저장소입니다. DGIST CSI Lab 인턴 프로젝트 "MoveIt2gather"의 Stage 1~3 결과물입니다.
...
docs/
├── guidebook.md          # 재현 가이드북 (설치 ~ ArUco pick-and-place)
